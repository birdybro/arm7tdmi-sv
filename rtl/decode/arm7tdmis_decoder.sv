...
(
    ...
    // ---- Scalar shortcuts. is_unimplemented stays at "DP-imm only" until
    //      the §9 core wires the DP-register execute path.
    assign is_dataproc      = (c == INSTR_DP);
    assign is_unimplemented = (c != INSTR_DP) || !dec.dp_use_imm;

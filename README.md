...
| EmbeddedICE-RT, JTAG, and trace boundary | **PARTIAL**. The broad §31.7/§31.8 matrix is verified, including debugger-issued system-speed aborts, the project-specific same-clock virtual-TCK transport, and the ARM-side ETM7 boundary. DBG-009 still requires the Debug Status write disposition. No asynchronous pod/GDB execution or ETM macrocell is claimed. |

...
| EmbeddedICE-RT, JTAG, and trace boundary | **PARTIAL**. The broad §31.7/§31.8 matrix is verified, including the project-specific same-clock virtual-TCK transport and ARM-side ETM7 boundary, but DBG-008/009 still require the system-speed-abort path and Debug Status write disposition. No asynchronous pod/GDB execution or ETM macrocell is claimed. |
...
The unchecked debug edge cases, whole-TRM inventory, Chapter 8/selected-framework
FPGA timing, framework/PocketStation integration, clean-checkout reproducibility,

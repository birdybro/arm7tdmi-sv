...
|---|---|
| ARM/Thumb architecture | **VERIFIED** for the directed requirements in §31.3, including all Thumb format families, reserved space, PC/PSR rules, operand policies, dependencies, and state changes. Independent QEMU differential, constrained-random, pinned public ARM/Thumb suite, compiler-program, sanitizer/X-state soak, and exact Chapter 7 cycle-cross gates also pass; encoding-level functional-coverage and formal closure remain **PARTIAL** under §31.10. |
